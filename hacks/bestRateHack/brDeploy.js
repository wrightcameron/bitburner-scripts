...
export async function main(ns) {
    ...
    let dest = (ns.args.length >= 1) ? ns.args[0] : ns.getHostname();
    let target = (ns.args.length >= 2) ? ns.args[1] : dest;
    let ratePrecent = (ns.args.length >= 3) ? ns.args[2] : 0.50;
    ...
    // TODO What if something else is running on this server?  Need smarter code for finding if there is enough ram.
